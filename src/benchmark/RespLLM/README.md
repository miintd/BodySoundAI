...
```
python src/benchmark/RespLLM/RespLLM.py --llm_model GPT2 --train_tasks S1,S2,S3,S4,S5,S6,S7 --test_tasks S5,S6 --train_epochs 10 --meta_val_interval 3  --train_pct 1 --batch_size 16 --llm_dim 768 --d_ff 768 >> out_RespLLM_GPT2_dwt.txt
```
